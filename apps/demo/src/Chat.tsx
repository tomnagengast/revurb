...
export function Chat() {
  ...
  const reverbHost = config.host;
  const reverbPort = Number.parseInt(config.port, 10) || 8080;
  const reverbScheme = config.scheme;
  const reverbAppKey = config.appKey;
